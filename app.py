...
def stats(message):
    ...
    text = (f"📊 **آمار سیستم**\n\n"
            ...
            f"🖥️ ظرفیت خالی: {machine_stats['available']:,} از {machine_stats['total_capacity']:,}\n"
