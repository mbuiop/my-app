...
"""
═══════════════════════════════════════════════════════════════════════════════
🚀 ربات مادر نهایی - نسخه 18.5 Enterprise
⚡ دارای: سیستم رفرال لینک ثابت + اشتراک ماهیانه + پنل مدیریت کامل
═══════════════════════════════════════════════════════════════════════════════
"""
...
if __name__ == "__main__":
    print("=" * 80)
    print("🚀 ربات مادر نهایی - نسخه 18.5 Enterprise".center(80))
    print("=" * 80)
